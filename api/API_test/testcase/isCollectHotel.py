...
class Hotel_isCollectHotel(unittest.TestCase):
	def setUp(self):
		print('开始测试')
	def test_isCollectHotel(self):
		url=r'https://'+api_data.Host+r"/h5/HOTELSELLINTERFACEWEB/api/isCollectHotel"
		data={"HotelID":method_get_data.get_HotelID()}
		headers={
