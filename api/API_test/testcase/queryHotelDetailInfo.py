...
class Hotel_queryHotelDetailInfo(unittest.TestCase):
	def setUp(self):
		print('开始测试')
	def test_queryHotelDetailInfo(self):
		url=r'https://'+api_data.Host+r"/h5/HOTELSELLINTERFACEWEB/api/queryHotelDetailInfo"
		data=[method_get_data.get_HotelID()]
		headers={
