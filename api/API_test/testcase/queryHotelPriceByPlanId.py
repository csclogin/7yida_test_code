...
class Hotel_queryHotelPriceByPlanId(unittest.TestCase):
	def setUp(self):
		print('开始测试')
	def test_queryHotelPriceByPlanId(self):
		url=r'https://'+api_data.Host+r"/h5/HOTELSELLINTERFACEWEB/api/queryHotelPriceByPlanId"
		data={
